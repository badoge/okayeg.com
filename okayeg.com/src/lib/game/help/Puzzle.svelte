...
<p>
  ...
  <br />
  Elements can only be swapped horizontally or vertically into the free space. Puzzle pieces cannot be swapped with each other directly.
</p>
...
<p>
  Check out the <i>settings menu</i> if you need to amp up the accessibility for the game.
</p>
