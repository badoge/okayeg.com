...
<div class="modal-content">
  ...
  <div class="modal-body">
    ...
    {:else}
      ...
      <p>
        <b><IcBaselineSettings /> Settings</b> menu allows you to customize your experience. Some options are only available once you get into the game.
      </p>
    {/if}
    ...
    <div class="authorship text-muted">
      ...
      created with <IcBaselineFavorite class="text-red" /> by
