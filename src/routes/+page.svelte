...
<div class="flex justify-center m-10">
  <div class="flex flex-wrap gap-3">
    <div class="card card-border border-accent w-80 h-65 bg-base-100 shadow-md">
      <div class="card-body">
...
<div class="flex justify-center">
  <div class="prose">
    ...
    <p>
      Egs get reset every month, You can check your all time stats on your
      <a class="link" href="/profile"><IcBaselineAccountCircle />Profile</a>
    </p>
